...
public class TaskTideExecutorTests {
    ...
    private static final Logger logger = LogManager.getLogger(TaskTideExecutorTests.class);
    
    public TaskTideExecutorTests() {}
    
    
    @BeforeAll
    public static void setUpClass() {        
        String msg = "\n\n---------------- Initiating TaskTideExecutor Tests ----------------\n";
        logger.info(msg);
    }
    
    @AfterAll
    public static void tearDownClass() {
        String msg = "\n\n---------------- Terminating TaskTideExecutor Tests ----------------\n";
        logger.info(msg);
    }
