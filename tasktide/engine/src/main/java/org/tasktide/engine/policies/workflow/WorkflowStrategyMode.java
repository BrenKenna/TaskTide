...
/**
 * Enum to support operations over valid {@link RoundRobinWorkflowStrategy} modes
 *
 * @author Bren
 */
public enum WorkflowStrategyMode {
     ...
     *
     * @param query
     * @return WorkflowStrategyMode
     */
    public static WorkflowStrategyMode get(String query) {
