...
class OrchestratorSpies {
     ...
     */
    private OrchestratorSpies(MutexActor nfsMutex, MutexActor fileChannelMutex) {
    ...
    /**
     * Initializes instance with provided {@link MutexActor} instances
    ...
    public static synchronized OrchestratorSpies configure() {
        if ( INSTANCE == null ) {
            MutexActor nfsMutes = spy(new NfsMutexActor() );
            MutexActor fileChannelMutex = spy(new FileChannelActor() );
    ...
    /**
     * Fetch {@link NfsMutexActor}
     * 
     * @return {@link NfsMutexActor}
     */
    public MutexActor getNfsMutex() {
     ...
     * Fetch {@link NfsMutexActor}
     * 
     * @return {@link FileChannelActor}
     */
    public MutexActor getFileChannelMutex() {
