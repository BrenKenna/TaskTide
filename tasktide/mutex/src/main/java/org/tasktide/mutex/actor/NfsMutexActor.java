...
/**
 * Package private implementation of the {@link InterProcessMutexActor} for
 *  shared file system
 *
 * @author Brendan Kenna
 */
public class NfsMutexActor extends InterProcessMutexActor {
    
    // Attributes
    private final Logger LOGGER = LogManager.getLogger(NfsMutexActor.class);
