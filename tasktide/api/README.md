...
Hateoas request hook, and data point specific security contexts are templated for their incoporation into version-2. As having the RESTful API by iteself was required for deployment use-case.
</p>