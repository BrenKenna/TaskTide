...
/**
 * {@link AbstractResourcePermission} typed for {@link Workflow}
 *
 * @author Bren
 */
@jakarta.nosql.Entity("WorkflowResourcePermission")
@jakarta.persistence.Entity
@jakarta.persistence.Table(name = "WorkflowResourcePermission")
public class WorkflowResourcePermission extends AbstractResourcePermission<WorkflowResourcePermission> {

    /**
     * Default constructor
     * 
     */
    public WorkflowResourcePermission() {
        super();
    }
