...
/**
 * {@link AbstractResourcePermission} typed for {@link MetricData}
 *
 * @author Bren
 */
@jakarta.nosql.Entity("MetricDataResourcePermission")
@jakarta.persistence.Entity
@jakarta.persistence.Table(name = "MetricDataResourcePermission")
public class MetricDataResourcePermission extends AbstractResourcePermission<MetricDataResourcePermission> {

    /**
     * Default constructor
     * 
     */
    public MetricDataResourcePermission() {
        super();
    }
