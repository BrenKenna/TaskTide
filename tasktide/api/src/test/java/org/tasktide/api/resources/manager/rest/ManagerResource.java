 ...
 */
package org.tasktide.api.resources.manager.rest;
...
public class ManagerResource {
    ...
    public Response importTasks(
        ...
        LOGGER.info(
            ...
            securityContext.getUserPrincipal().getName(), ip, userAgent, cmd.toJsonDoc()
        );
        ...
        LOGGER.info(
            ...
            securityContext.getUserPrincipal().getName(), ip, userAgent, output
        );
