...
/**
 * {@link AbstractResourcePermission} typed for {@link WorkItem}
 *
 * @author Bren
 */
@jakarta.nosql.Entity("WorkItemResourcePermission")
@jakarta.persistence.Entity
@jakarta.persistence.Table(name = "WorkItemResourcePermission")
public class WorkItemResourcePermission extends AbstractResourcePermission<WorkItemResourcePermission> {

    /**
     * Default constructor
     * 
     */
    public WorkItemResourcePermission() {
        super();
    }
