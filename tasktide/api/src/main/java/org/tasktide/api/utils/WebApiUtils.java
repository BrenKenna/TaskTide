...
public class WebApiUtils {
    ...
    public static RSAPublicKey getPublicKey() {
        try {
            return (RSAPublicKey) WebApiUtils.getKeyPair().getPublic();
        }
        catch ( Exception ex ) {
            return null;
        }
    ...
    public static boolean requireUser(SecurityContext ctx) {
        return ctx.getUserPrincipal() != null;
    }

    public static boolean requireRole(SecurityContext ctx, String role) {
