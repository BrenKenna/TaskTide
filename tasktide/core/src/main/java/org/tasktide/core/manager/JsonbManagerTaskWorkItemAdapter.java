...
/**
 * For parsing {@link WorkItem} from {@link ManagerTask} records
 *
...
public class JsonbManagerTaskWorkItemAdapter implements JsonbAdapter<WorkItem, ManagerTask> {
    ...
    @Override
    public WorkItem adaptFromJson(ManagerTask managerTask) throws Exception {
        return managerTask.asWorkItem();
    }
}