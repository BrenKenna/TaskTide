...
/**
 * WorkItemService test module. Focuses on JsonRepository
 * 
 * <ul>
...
public class WorkItemServiceTest {
    ...
    private static final Logger logger = LogManager.getLogger(WorkItemServiceTest.class);
    ...
    public void cannotAddDuplicateTask() {
        ...
        WorkItem item = serv.appendTask(serv.viewItems().get(0), task);
    ...
    public void canLockItem() {
        ...
        WorkItem toLock = serv.viewItems().get(0);
    ...
    public void canMarkAsDone() {
        ...
        WorkItem pendDone = serv.viewItems().get(0);
    ...
    public void canFindByField() {
        ...
        // Fetch 
        List<WorkItem> results = serv.viewItemsByField("itemState", ItemState.TODO);
        if ( results != null ) {
            assertionState = true;
